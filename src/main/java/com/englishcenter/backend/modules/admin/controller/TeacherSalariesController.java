...
import com.englishcenter.backend.modules.admin.service.Impl.TeacherSalariesServiceImpl;
...
public class TeacherSalariesController {
    ...
    public org.springframework.http.ResponseEntity<?> generateSalaries(@RequestParam String month) {
        try {
            teacherSalariesService.generateTeacherSalaries(java.time.LocalDate.parse(month));
