...
import com.englishcenter.backend.modules.admin.service.Impl.FeeRecordsServiceImpl;
...
public class FeeRecordsController {
    ...
    public org.springframework.http.ResponseEntity<?> generateFees(@PathVariable Long classId, @RequestParam String month) {
        ...
        try {
            feeRecordsService.generateMonthlyFees(classId, java.time.LocalDate.parse(month));
