...
import com.englishcenter.backend.modules.admin.service.FeeRecordsService;
...
public class FeeRecordsServiceImpl implements FeeRecordsService {
    ...
    @Autowired
    private com.englishcenter.backend.core.repository.ClassStudentsRepository classStudentsRepository;
    
    @Autowired
    private com.englishcenter.backend.core.repository.ClassesRepository classesRepository;
    
    @org.springframework.transaction.annotation.Transactional
    public void generateMonthlyFees(Long classId, java.time.LocalDate month) {
        com.englishcenter.backend.core.entity.Classes classInfo = classesRepository.findById(classId).orElse(null);
        if (classInfo == null) return;
        
        List<com.englishcenter.backend.core.entity.ClassStudents> students = classStudentsRepository.findByClassId(classId);
        for (com.englishcenter.backend.core.entity.ClassStudents cs : students) {
